...
sed -e "s/INSTANCE_NAME/$INSTANCE_NAME/" -e "s/INSTANCE_IP/$INSTANCE_IP/" >/tmp/record.json

$ aws route53 change-resource-record-sets --hosted-zone-id Z052810734RA51WPWCU75 --change-batch file:///tmp/record.json
